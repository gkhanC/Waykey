...
module.exports = (WayKey) => {
    ...
    // 💡 Not: Hotstring tetiklenmesi için tetikleyicinin ayrı yazılması (başında boşluk olması) 
    // veya satır başında olması gerekir. Örneğin 'xxxbtw' tetiklenmezken 'xxx btw' tetiklenir.
};
```
